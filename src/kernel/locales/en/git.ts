...
export const MESSAGES = {
  ...
  "{branch} 已是最新": "{branch} is already up to date",
  "{branch} 的远端引用已是最新": "Remote refs for {branch} are already up to date",
  "凭据需要交互,请到幕布终端执行 git 命令": "Credentials require interaction — run git in the terminal",
  "先创建首个提交": "Create the first commit first",
  "重命名分支": "Rename branch",
  "原分支名:": "Current name:",
