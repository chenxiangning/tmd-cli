...
export const MESSAGES = {
  ...
  "剪切": "Cut",
  "粘贴": "Paste",
  "发送到输入框": "Send to input",
  "Git 操作": "Git actions",
  "定位到文件": "Locate in file tree",
  "暂存": "Stage",
  "取消暂存": "Unstage",
  "确认放弃改动?": "Discard changes?",
  "扩大选择范围": "Expand selection",
  "显示文件历史": "Show file history",
  "显示 Git Blame": "Show Git Blame",
  "{path} — 文件历史": "{path} — file history",
  "{path} — Git Blame": "{path} — Git Blame",
  "该文件暂无提交历史": "No commits touch this file yet",
  "文件为空,无归属行": "File is empty; nothing to blame",
  "查看该提交的 diff": "View diff of this commit",
