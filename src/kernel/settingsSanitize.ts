...
export function sanitize(raw: unknown): AppSettings {
  ...
  return {
    ...
    webRelayCertDer: typeof obj.webRelayCertDer === "string" ? obj.webRelayCertDer.slice(0, 4096) : "",
    webRelayCertHost: typeof obj.webRelayCertHost === "string" ? obj.webRelayCertHost.slice(0, 200) : "",
