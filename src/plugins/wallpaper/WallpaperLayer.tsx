...
export function WallpaperLayer() {
  ...
  const active = state.enabled && !!media && !preview.failed;
  ...
  const rotationOn = active && state.rotationEnabled && visibleIds.split("|").length >= 2;
  useEffect(() => {
  ...
  return (
    <div className="tmd-wallpaper" aria-hidden data-testid="tmd-wallpaper">
      <img
