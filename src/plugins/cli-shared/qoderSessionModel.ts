/**
 * qoder 双分发版共享内核(域逻辑层)—— 国际版(qodercli/~/.qoder)与国内版
 * (qoderclicn/~/.qoder-cn)的同一磁盘格式知识(实证 2026-09-02,本机
 * qodercli 1.1.33 / qoderclicn 1.1.28)。
 *
 ...
 *
 * 从 qoderSessions.tsx 拆出(only-export-components):组件在 qoderSessions.tsx,
 * 插件装配在 qoderPlugin.tsx,本文件只留常量与 IO/纯函数。
 */
